...
public class BarCard extends DefaultItem{
	...
	/**
	 * Our main object class for bars!
	 * Mostly a lot of swing stuff
	 * TODO we may consider splitting this class up in some way and have an extend onto a new class -Shaun
	 * 
	 * @param barID
	 * @param barName
	 * @param address
